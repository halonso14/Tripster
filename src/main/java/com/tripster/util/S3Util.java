...
import com.tripster.common.PrivateKey;

public class S3Util {

	private String accessKey = PrivateKey.getS3accesskey(); // 엑세스 키
	private String secretKey= PrivateKey.getS3secretkey(); // 보안 엑세스 키
