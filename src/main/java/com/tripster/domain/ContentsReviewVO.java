...
public class ContentsReviewVO {
	...
	public void setContentsReviewRating(Integer contentsReviewRating) {
	...
	public String toString() {
		return "ContentsReviewVO [memberID=" + memberID + ", contentsID=" + contentsID + ", contentsReviewID="
				+ contentsReviewID + ", contentsReview=" + contentsReview + ", contentsReviewRating="
				+ contentsReviewRating + ", reviewPictureName=" + reviewPictureName + "]";
	}
}