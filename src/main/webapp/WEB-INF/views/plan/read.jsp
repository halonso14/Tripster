				...
				<div class="col-md-12 pagecontainer2 offset-0" >
					<div class="hpadding50c">
						<div class="planHeader">
							<span class="lato size28 slim">${plan.planTitle}&nbsp;&nbsp;&nbsp;&nbsp;
								<!-- 좋아요 -->
								<c:choose>
									<c:when test='${likeChk ne 1 }'>
										<span><a id="likeBtn" class="fav-icon-black like" href="javascript:void(0)" onclick="likeClick('${session.memberID}',$(this));"  value= ${plan.planID  } likeBtnCheck='0' style="top:30px;"></a></span>
									</c:when>
									<c:otherwise>
										<span style="margin-right:0 20px"><a id="likeBtn" class="fav-icon-black fav-icon-red like" href="javascript:void(0)" onclick="likeClick('${session.memberID}',$(this));" value= ${plan.planID } likeBtnCheck='1' style="top:30px;"></a></span>
									</c:otherwise>
								</c:choose>
							</span> 
						...
						<div class="lato size15 grey bold">
							...
							<span class="member_name">
								<ul id="writer">
									<li class="dropdown">
										작성자 :&nbsp;&nbsp; <a data-toggle="dropdown" class="dropdown-toggle" href="#"> ${memberName} <b class="lightcaret mt-2"></b></a>
										<!-- 일정 리스트 페이지 링크. -->
